...
CMD ["sh", "-c", "echo '=== SYNCING DOCS & PUBLIC ===' && mkdir -p /app/src/content/docs/question-banks /app/public/pdfs && cp -rf /app/initial_docs/* /app/src/content/docs/ && cp -f /app/initial_docs/index.md /app/src/content/docs/index.md && rm -f /app/src/content/docs/courses/common/e401-20th-century-english-lit-1.md /app/src/content/docs/courses/common/e403-critical-and-cultural-theory.md && cp -r /app/initial_public/* /app/public/ 2>/dev/null || true && echo '=== QUESTION BANKS LIST: ===' && ls -la /app/src/content/docs/question-banks/ && npm run dev"]
